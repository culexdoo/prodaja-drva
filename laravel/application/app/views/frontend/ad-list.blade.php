                    ...
                    <div class="row box">
                        <div class="single-ad">
                            <div class="col-lg-4 p0">
                                <div class="ad-image">
                                    {{ HTML::image(URL::to('/') . '/uploads/frontend/ads/thumbs/' . $entry->image, $entry->title) }}
                                </div>
                            </div>
                            <div class="col-lg-8 mb20">
                                <div class="ad-content">
                                    <div class="col-lg-10 p0">
                                        <a href="{{ URL::route('ShowAd', array('permalink' => $entry->permalink)) }}">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-5">
                                            ...
                                            <h5 class="ad-category" style="margin: 0px;">{{$entry->woodname}}</h5> 
                                        </div>
                                        <div class="col-lg-6">
                                            <p style="margin-top: 15px; margin-bottom: 0px;">Vrsta pakiranja:</p>
                                            <h5 class="ad-category" style="margin: 0px;">{{$entry->packagingname}}</h5> 
                                        </div>
                                    </div>
                                </div>
                                <div class="ad-footer">
