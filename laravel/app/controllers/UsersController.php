...
*/
		...
		$this->layout->content = View::make('backend.users.edit', array('entry' => $entry['entry'], 'postRoute' => 'UsersUpdate', 'regionlist' => $regionlist, 'getRoute' => 'UsersEdit', 'citylist' => $citylist,));
	}
