...
*/
		...
		$this->layout->content = View::make('backend.ads.show', array('entry' => $entry['entry'], 'regionname' => $regionname, 'cityname' => $cityname, 'woodname' => $woodname, 'packaging' => $packaging));
	}
...
*/
		...
		$this->layout->content = View::make('backend.ads.edit', array('entry' => $entry['entry'], 'postRoute' => 'AdsUpdate', 'usernamelist' => $usernamelist, 'regionlist' => $regionlist, 'citylist' => $citylist, 'woodlist' => $woodlist, 'packaginglist' => $packaginglist));
	}
...
*/		// - AUTHORITY CHECK ENDS HERE - // 
		...
		if ($id == null)
		{
			return Redirect::route('AdsIndex')->with('error_message', Lang::get('core.msg_error_getting_entry'));
		}
