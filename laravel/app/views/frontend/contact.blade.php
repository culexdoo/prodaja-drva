            ...
            <div class="col-md-8 p0">
                ...
                {{ Form::open(array('route' => $postRoute, 'role' => 'form', 'class' => 'form-horizontal', 'autocomplete' => 'off', 'files' => true)) }}
                    ...
                    <div class="control-group form-group">
                        <div class="controls">
                            <label>Poruka:</label>
                            {{ Form::textarea('content', isset($entry->content) ? $entry->content : null, ['id' => 'content', 'placeholder' => 'Sadržaj oglasa', 'cols' => '110', 'rows' => '10', 'style' => 'border: 1px solid #CCC; border-radius: 5px;']) }}
                        </div>
                    </div>
                    <div id="success"></div>
