	...
	<div class="row">
	    ...
	    <div class="col-md-8">
	            ...
	            <div class="form-group">  
					...
					{{ Form::text('author', isset($entry->author) ? $entry->author : null, ['class' => 'form-control', 'id' => 'author', 'placeholder' => 'Autor posta']) }}
	    ...
	    <div class="col-md-4"> 
	       <div class="form-group m0 mb15">
	            ...
	            {{ Form::select('status', array('draft' => 'Draft', 'objavljeno' => 'Objavljeno'), 'draft', array('class'=>'form-control','style'=>'' )) }}
	        </div>
	        <div class="form-group m0 mb15"> 
