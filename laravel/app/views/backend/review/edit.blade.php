                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body col-md-8"> 
                                ...
                                <div class="form-group plr20">
                                    ...
                                    {{ Form::textarea('review_content', isset($entry->review_content) ? $entry->review_content : null, ['id' => 'review_content', 'placeholder' => 'Sadržaj oglasa', 'cols' => '141', 'rows' => '8', 'style' => 'border: 1px solid #CCC; border-radius: 5px;']) }}
                                </div>
                                <div class="col-md-12 mb15 p0">
                                <p>Ocijeni korisnika</p>
